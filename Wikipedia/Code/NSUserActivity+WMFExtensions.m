...
+ (instancetype)wmf_placesActivityWithURL:(NSURL *)activityURL {
    ...
    // If the places URL contains a specific location extract the coordinates and save it
    if ([activityURL.absoluteString containsString:@"location"]) {
        double latitude = 0.0;
        ...
        activity.location = [[CLLocation alloc] initWithLatitude:latitude longitude:longitude];
    }
